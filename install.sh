...
# 2. SELEBRAM BARU: Suntik otomatis alias mrh_update_stock ke .bashrc
...
# Refresh konfigurasi terminal biar alias langsung aktif seketika
if [ -f ~/.bashrc ]; then
    source ~/.bashrc
fi
...
echo -e "${G}Sekarang kamu bisa ketik perintah ringkas: mrh_update_stock${N}"
echo -e "${G}===========================================${N}"

# Langsung jalankan bot di akhir instalasi pertama kali
python bot_rok.py
